...
const uri = 'mongodb://localhost:27018/?directConnection=true'; // Replace with your sharded MongoDB connection strings  
...
async function main(nome, contenuto, prezzo) {4
  try {
    ...
    const collection = db.collection('collectionA'); // Replace with your actual collection name
